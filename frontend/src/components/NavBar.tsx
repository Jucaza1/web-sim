  ...
  return (
    <nav className="px-6 py-4 flex items-center justify-between">
      ...
      <div className="hidden md:flex gap-6 items-center">
        ...
        <Link to="/simulatorspage" className="hover:text-orange-500">
          Simuladores
        </Link>
        ...
        {loggedIn ? (
          <div>
            <img
              src={defaultProfileDark}
              alt="Perfil"
              className="h-8 w-8 rounded-full logo-dark"
              onClick={() => navigate("/profile")}
            />
            <img
              src={defaultProfileLight}
              alt="Perfil"
              className="h-8 w-8 rounded-full logo-light"
              onClick={() => navigate("/profile")}
            />
            <div
              className="cursor-pointer text-sm text-gray-700 dark:text-white hover:underline"
              onClick={() => navigate("/profile")}
            >
