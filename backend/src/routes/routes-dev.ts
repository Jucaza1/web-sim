...
export function createRouter(
    ...
    router.post("/dev/admin", userController.createAdmin)
    router.post("/dev/admincompany", userController.createAdminCompany)
    ...
    routerAuth.post("/admin", userController.createAdmin)
    routerAuth.post("/admincompany", userController.createAdminCompany)
